...
if ( !class_exists('CUAR_CustomerUpdateFileAddOn')) :
    ...
    class CUAR_CustomerUpdateFileAddOn extends CUAR_AbstractUpdateContentPageAddOn
    {
        ...
        public function __construct()
        {
            ...
            $this->set_page_parameters(550, array(
        ...
        {
            return array(
                array('id' => 'file-details', 'label' => __('File details', 'cuarco')),
                array('id' => 'attachments', 'label' => __('Attachments', 'cuarco')),
            );
        }
        ...
        protected function do_edit_content($action, $form_data)
        {
            ...
            if ($post_id > 0 && $title !== false && $content !== false && $owners !== false && $category !== false)
            {
                ...
                $post_id = $co_addon->update_private_content('cuar_private_file', $post_id, $title, $content, $owners, $this->get_friendly_taxonomy(),
                    $category);

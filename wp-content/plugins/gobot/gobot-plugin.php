...
//
// Gobot plugin activation/deactivation
//
// function gobot_activation() {}
// register_activation_hook(__FILE__, 'gobot_activation');

// function gobot_deactivation() {}
// register_deactivation_hook(__FILE__, 'gobot_deactivation');

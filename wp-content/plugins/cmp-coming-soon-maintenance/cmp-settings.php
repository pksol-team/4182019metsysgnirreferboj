				...
				<tr>
					...
					<td>
						...
						<fieldset class="cmp-status-pages"  style="display: <?php echo ( $this->cmp_active() == '1' ) ? 'block' : 'none';?>">
							<label for="cmp-status-pages-0"<?php echo ($cmp_status_pages == '0') ? ' class="active"' : '';?>>
								<input type="radio" name="cmp-status-pages" id="cmp-status-pages-0" value="0" <?php checked( '0', $cmp_status_pages ); ?>>
								<?php _e('Whole Website', 'cmp-coming-soon-maintenance');?>
							</label>

							<label for="cmp-status-pages-1"<?php echo ($cmp_status_pages == '1') ? ' class="active"' : '';?>>
								<input type="radio" name="cmp-status-pages" id="cmp-status-pages-1" value="1" <?php checked( '1', $cmp_status_pages ); ?>>
								<?php _e('Homepage only', 'cmp-coming-soon-maintenance');?>
							</label>

							<a href="<?php echo admin_url(); ?>admin.php?page=cmp-advanced"><div class="label<?php echo ($cmp_status_pages == '2') ? ' active' : '';?>">
								<input type="radio" name="cmp-status-pages" id="cmp-status-pages-2" value="2" <?php checked( '2', $cmp_status_pages ); ?>>

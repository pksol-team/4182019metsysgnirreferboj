...
if (!class_exists('CUAR_UserGroupAddOn')) :
    ...
    class CUAR_UserGroupAddOn extends CUAR_AddOn
    {
        ...
        {
            $post_types['cuar_user_group'] = array(
                "label-singular"     => _x('User Group', 'cuar_user_group', 'cuarep'),
                "label-plural"       => _x('User Groups', 'cuar_user_group', 'cuarep'),
        ...
        /**
         * Get the user groups in the system corresponding to the search
         *
         * @param $search
         * @param $page
        ...
        public function get_selectable_groups($search, $page)
        {
            ...
            return $po_addon->ajax()->find_posts($search, 'user-groups', $page, array(
                'post_type' => "cuar_user_group",
            ));
        }
